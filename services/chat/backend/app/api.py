...
from .database import api_session_factory, database_session
from .identity import Actor, current_actor, require_admin
...
async def create_session(
    body: SessionCreate, session: Database, actor: CurrentActor
) -> dict[str, object]:
    try:
